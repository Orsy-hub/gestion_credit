...
<!-- <a href="{{ route('contracts') }}" class="relative flex items-center border-l-2 px-5 py-2 gap-2 text-slate-700 transition-colors duration-200 hover:text-slate-400 active:text-slate-800 font-bold">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
