...
>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      <button 
        @click="isOpen = true"
        class="flex px-5 py-3 gap-2 rounded-lg bg-green-800 text-white font-ubuntu transition-colors duration-300 hover:bg-green-600 active:bg-green-900"
      >
      ...
      <button 
        @click="open = !open" 
        class="border px-5 py-3 flex gap-2 rounded-lg transition-colors duration-300 hover:bg-slate-200 active:bg-slate-400"
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
